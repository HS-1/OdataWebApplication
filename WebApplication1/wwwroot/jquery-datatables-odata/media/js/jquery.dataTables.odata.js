...
function fnServerOData(sUrl, aoData, fnCallback, oSettings) {
    ...
    $.ajax(jQuery.extend({}, oSettings.oInit.ajax, {
        ...
        "success": function (data) {
            ...
            if (oDataSource.aaData == undefined) {
                oDataSource.aaData = data;
                if (data.length == undefined) {
                    oDataSource.iTotalDisplayRecords = 0;
                    oDataSource.iTotalRecords = 0;
                }
                else {
                    oDataSource.iTotalDisplayRecords = data.length;
                    oDataSource.iTotalRecords = data.length;
                }
            }
            else {
                if (iCount == null) {
